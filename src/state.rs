...
pub(crate) struct App {
    ...
    pub(crate) shell_pending_input: bool,
    ...
    pub(crate) help_context: ActivePane,
    ...
    pub(crate) nav_backspace_parent_ready: bool,
    pub(crate) nav_filter_char_held: Option<char>,
    ...
    pub(crate) preview_jump_input: String,
    pub(crate) preview_jump_user_typed: bool,
    pub(crate) preview_jump_history: Vec<String>,
    pub(crate) preview_jump_history_index: Option<usize>,
    pub(crate) preview_jump_completions: Vec<String>,
    pub(crate) preview_jump_status: Option<String>,
    pub(crate) preview_jump_cycle_seed: Option<String>,
    pub(crate) preview_jump_cycle_index: Option<usize>,
    pub(crate) nav_preferred_selection_path: Option<PathBuf>,
